...
// Tests for Director.js - Entity director system
...
describe( 'createDirector', () => {
	test( 'creates director with empty containers', () => {
...
describe( 'Director.register', () => {
	...
	test( 'uses defaults for missing metadata', () => {
		...
		// Director uses 0 as default for drawLayer/updateGroup (generic, not game-specific)
...
describe( 'Director.allForMinimap', () => {
...
describe( 'Director.countByGroups', () => {
...
describe( 'Director.isPrimaryEnemy', () => {
...
describe( 'Director.allPrimaryEnemiesDead', () => {
...
describe( 'Director.getPrimaryEnemyTypes', () => {
...
describe( 'Director.sync', () => {
	test( 'syncs external array to director', () => {
		const reg = createDirector()
...
describe( 'Director.add', () => {
	test( 'adds entity to director', () => {
		const reg = createDirector()
